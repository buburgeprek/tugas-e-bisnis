...
if (isset($_POST['add_to_cart'])) {
    ...
    if (!isset($_SESSION['user_id'])) {
        // Jika belum login, arahkan ke halaman masuk.php
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul>
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <li class="profile-dropdown" id="profileDropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="keranjang.php" class="dropdown-item profile-link">
            ...
            <?php else: ?>
                <!-- Tombol Login/Register (hanya tampil jika user belum login) -->
                <li class="auth-buttons">
                    <a href="masuk.php" class="auth-btn login">
    ...
    <section class="menu-header">
        ...
        <?php else: ?>
            <h1>Menu Baker Old</h1>
            <p>Silakan login untuk menambahkan item ke keranjang dan melakukan pemesanan</p>
        <?php endif; ?>
    </section>
    ...
    <div class="promo-banner">
        <div class="promo-content">
            <h3 class="promo-title">
                ...
                PROMO SPESIAL: Diskon hingga 90% Untuk semua roti!
            </h3>
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            ...
            <div class="menu-card">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="add_to_cart" class="btn btn-cart <?= ($is_out_of_stock || $is_expired || !isset($_SESSION['user_id'])) ? 'btn-disabled' : ''; ?>" 
                        <?= ($is_out_of_stock || $is_expired || !isset($_SESSION['user_id'])) ? 'disabled' : ''; ?>>
